...
function App() {
  ...
  return (
    <div>
      <header className="bg-surface-50-950 sticky top-0 z-50 shadow-xl">
        <div className="container mx-auto grid grid-cols-[auto_1fr_auto] items-center gap-10 p-4">
          <h1 className="h3">Skeleton</h1>
          <p className="collapse text-xs opacity-60 md:visible">
      ...
      <main className="container mx-auto space-y-20 px-4 py-20">
        ...
        <section className="space-y-4">
          ...
          <div className={previewCardClasses}>
            <div className="grid grid-cols-3 gap-4">
              ...
              <button
                type="button"
                className="btn preset-outlined-secondary-500"
              >
                Button
              </button>
              {/* --- */}
              ...
              <button
                type="button"
                className="btn preset-outlined-tertiary-500"
              >
                Button
              </button>
              {/* --- */}
        ...
        <section className="space-y-4">
          ...
          <div className={previewCardClasses}>
            <a
              href="#card"
              className="card preset-filled-surface-100-900 border-surface-200-800 card-hover divide-surface-200-800 block max-w-md divide-y overflow-hidden border-[1px]"
            >
              <header>
                <img
        ...
        <section className="space-y-4">
          ...
          <div className={previewCardClasses}>
            <div className="grid grid-cols-4 gap-5">
              ...
              <Avatar>
                <Avatar.Fallback className="preset-tonal">
                  &rarr;
                </Avatar.Fallback>
              </Avatar>
              {/* --- */}
              ...
              <Avatar>
                <Avatar.Fallback className="preset-filled-primary-500">
                  V
                </Avatar.Fallback>
              </Avatar>
              <Avatar>
              ...
              <Avatar>
                <Avatar.Fallback className="preset-tonal-primary">
                  V
                </Avatar.Fallback>
              </Avatar>
              <Avatar>
        ...
        <section className="space-y-4">
          ...
          <div className={previewCardClasses}>
            <div className="flex items-center md:space-x-16">
              <Progress
                value={25}
                className="hidden w-fit items-center md:block"
              >
                <Progress.Circle>
        ...
        <section className="space-y-4">
          ...
          <div className={previewCardClasses}>
            <div>
              Press <kbd className="kbd">⌘</kbd> + <kbd className="kbd">C</kbd>{" "}
              to copy.
            </div>
          </div>
        </section>
            ...
            <div className="grid w-full max-w-xl grid-cols-1 gap-4">
              <div className="card preset-outlined-success-500 grid grid-cols-1 items-center gap-4 p-4 lg:grid-cols-[1fr_auto]">
                <div>
                  ...
                  <p className="type-scale-1 opacity-60">
