<script lang="ts">
	import { Avatar, Progress, SegmentedControl, Slider, Switch } from '@skeletonlabs/skeleton-svelte';
	...
	<section class="space-y-4">
		...
		<div class={previewCardClasses}>
			<div class="grid grid-cols-4 gap-5">
                <Avatar>
                <Avatar.Image src="https://i.pravatar.cc/150?img=10" alt="Random" class='grayscale' />
              </Avatar>
              <Avatar>
              ...
              <Avatar>
                <Avatar.Fallback class='preset-filled-primary-500'>&rarr;</Avatar.Fallback>
              </Avatar>
				<!-- --- -->
              <Avatar>
                <Avatar.Image src="https://i.pravatar.cc/150?img=10" alt="Random" class='grayscale' />
	...
	<section class="space-y-4">
		...
		<div class={previewCardClasses}>
			<div class="flex items-center md:space-x-16">
              <Progress value={25} class="items-center w-fit hidden md:block">
                <Progress.Circle>
              ...
              <Progress value={null} class="items-center w-fit hidden md:block">
                <Progress.Circle>
                  <Progress.CircleTrack />
