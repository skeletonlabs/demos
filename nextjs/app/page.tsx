...
import { Avatar, Progress, SegmentedControl, Slider, Switch } from '@skeletonlabs/skeleton-react';
	...
	return (
		<div>
			...
			<main className="container mx-auto space-y-20 px-4 py-20">
						...
						<form className="w-full max-w-xl mx-auto space-y-4">
							<fieldset className="space-y-4">
								...
								<label className="label">
									...
									<input className="input" type="range" defaultValue="75" max="100" readOnly />
								</label>
								{/* Progress */}
								<label className="label">
								...
								<div className="grid grid-cols-[auto_1fr] gap-2">
									...
									<input className="input" type="text" defaultValue={color} readOnly />
								</div>
							</fieldset>
						</form>
					</div>
              ...
              <Avatar>
                <Avatar.Image src="https://i.pravatar.cc/150?img=10" alt="Random" className='grayscale' />
              </Avatar>
              <Avatar>
              ...
              <Avatar>
                <Avatar.Fallback>&rarr;</Avatar.Fallback>
              </Avatar>
							{/* --- */}
              <Avatar>
                <Avatar.Image src="https://i.pravatar.cc/150?img=10" alt="Random" className='grayscale' />
              ...
              <Avatar>
                <Avatar.Fallback className='preset-tonal'>V</Avatar.Fallback>
              </Avatar>
              <Avatar>
                <Avatar.Fallback className='preset-tonal'>JD</Avatar.Fallback>
              </Avatar>
              <Avatar>
                <Avatar.Fallback className='preset-tonal'>&rarr;</Avatar.Fallback>
              </Avatar>
							{/* --- */}
              <Avatar>
                <Avatar.Image src="https://i.pravatar.cc/150?img=10" alt="Random" className='grayscale' />
              ...
              <Avatar>
                <Avatar.Fallback className='preset-filled-primary-500'>V</Avatar.Fallback>
              </Avatar>
              <Avatar>
                <Avatar.Fallback className='preset-filled-primary-500'>JD</Avatar.Fallback>
              </Avatar>
              <Avatar>
                <Avatar.Fallback className='preset-filled-primary-500'>&rarr;</Avatar.Fallback>
              </Avatar>
							{/* --- */}
              <Avatar>
                <Avatar.Image src="https://i.pravatar.cc/150?img=10" alt="Random" className='grayscale' />
              ...
              <Avatar>
                <Avatar.Fallback className='preset-tonal-primary'>V</Avatar.Fallback>
              </Avatar>
              <Avatar>
                <Avatar.Fallback className='preset-tonal-primary'>JD</Avatar.Fallback>
              </Avatar>
              <Avatar>
                <Avatar.Fallback className='preset-tonal-primary'>&rarr;</Avatar.Fallback>
              </Avatar>
						</div>
					</div>
				</section>
              ...
              <Progress value={25} className="items-center w-fit hidden md:block">
                <Progress.Circle>
              ...
              <Progress value={25} className="items-center w-fit hidden md:block">
                <Progress.Circle>
                  <Progress.CircleTrack />
                  <Progress.CircleRange className='stroke-success-500' />
                </Progress.Circle>
              </Progress>
              <Progress value={null} className="items-center w-fit hidden md:block">
                <Progress.Circle>
                  <Progress.CircleTrack />
                  <Progress.CircleRange className='stroke-error-500' />
                </Progress.Circle>
              </Progress>
						</div>
					</div>
				...
				<section className="space-y-4">
					...
					<div className={previewCardClasses}>
						<div className="flex items-center md:space-x-16">
                <SegmentedControl defaultValue="xs">
                  <SegmentedControl.Control>
                      <SegmentedControl.Indicator />
                      {['xs', 'sm', 'md', 'lg', 'xl'].map((size) => (
                        <SegmentedControl.Item value={size} key={size}>
                          <SegmentedControl.ItemText>{size}</SegmentedControl.ItemText>
