      ...
      <form class="mx-auto w-full max-w-xl space-y-4">
        <fieldset class="space-y-4">
          ...
          <div class="grid grid-cols-[auto_1fr] gap-2">
            ...
            <input class="input" type="text" bind:value={color} readonly />
          </div>
        </fieldset>
      </form>
    </div>
  ...
  <section class="space-y-4">
    ...
    <div class={previewCardClasses}>
      <div class="grid grid-cols-4 gap-5">
        ...
        <Avatar>
          <Avatar.Fallback class="preset-tonal">V</Avatar.Fallback>
        </Avatar>
        <Avatar>
          <Avatar.Fallback class="preset-tonal">JD</Avatar.Fallback>
        </Avatar>
        <Avatar>
          <Avatar.Fallback class="preset-tonal">&rarr;</Avatar.Fallback>
        </Avatar>
        <!-- --- -->
        <Avatar>
          <Avatar.Image
        ...
        <Avatar>
          <Avatar.Fallback class="preset-filled-primary-500">V</Avatar.Fallback>
        </Avatar>
        <Avatar>
          <Avatar.Fallback class="preset-filled-primary-500">JD</Avatar.Fallback
          >
        </Avatar>
        <Avatar>
          <Avatar.Fallback class="preset-filled-primary-500"
            >&rarr;</Avatar.Fallback
          >
        </Avatar>
        <!-- --- -->
        <Avatar>
        ...
        <Avatar>
          <Avatar.Fallback class="preset-tonal-primary">V</Avatar.Fallback>
        </Avatar>
        <Avatar>
          <Avatar.Fallback class="preset-tonal-primary">JD</Avatar.Fallback>
        </Avatar>
        <Avatar>
          <Avatar.Fallback class="preset-tonal-primary">&rarr;</Avatar.Fallback>
        </Avatar>
      </div>
    </div>
  </section>
  ...
  <section class="space-y-4">
    ...
    <div class={previewCardClasses}>
      <div class="flex items-center md:space-x-16">
        <Progress value={25} class="hidden w-fit items-center md:block">
          <Progress.Circle>
        ...
        <Progress value={25} class="hidden w-fit items-center md:block">
          <Progress.Circle>
            <Progress.CircleTrack />
            <Progress.CircleRange class="stroke-success-500" />
          </Progress.Circle>
        </Progress>
        <Progress value={null} class="hidden w-fit items-center md:block">
          <Progress.Circle>
            <Progress.CircleTrack />
        ...
        <SegmentedControl defaultValue="xs">
          <SegmentedControl.Control>
            ...
            {#each ["xs", "sm", "md", "lg", "xl"] as size (size)}
              <SegmentedControl.Item value={size}>
    ...
    <div class={previewCardClasses}>
      <div class="mx-auto max-w-xl">
        <blockquote class="blockquote">
          ...
          aliquid. Molestias, odio illum voluptatibus natus dignissimos, quidem
          est unde aspernatur veniam pariatur fuga distinctio esse in quas,
          repellendus neque reiciendis!"
        </blockquote>
      </div>
    </div>
  </section>
  ...
  <section class="space-y-4">
    ...
    <div class={previewCardClasses}>
      <ol class="flex items-center gap-4">
        ...
        <li>
          <a class="opacity-60 hover:underline" href="#breadcrumbs">Category</a>
        </li>
        <li class="opacity-50" aria-hidden="true">&rsaquo;</li>
        <li>Article</li>
      </ol>
